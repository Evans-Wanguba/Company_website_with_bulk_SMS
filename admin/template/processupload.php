...
$destination_folder		= 'C:/wamp/www/seedlingscode/seedlingscode/admin/uploads/'; //upload directory ends with / (slash)
...
if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
	...
	if($image_res){
		...
		if(normal_resize_image($image_res, $image_save_folder, $image_type, $max_image_size, $image_width, $image_height, $jpeg_quality))
		{
			...
			//echo '<br />';
			//echo '<img src="uploads/folder/'. $new_file_name.'" alt="Resized Image">';
			echo '</div>';
			...
			$sql="INSERT INTO picturedetails(seedid,pname,pnameold,type,size) VALUES('$seedlings','$thumb_prefix$new_file_name','$new_file_name','$image_type','$image_size')";
